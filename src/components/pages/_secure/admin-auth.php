...
function adminAuthJsonResponse($statusCode, $body, $withChallenge = false) {
  // Note: we intentionally do NOT send WWW-Authenticate header for API endpoints
  // to prevent the browser from showing its native HTTP Basic auth popup.
  // The frontend handles authentication via sessionStorage token.
